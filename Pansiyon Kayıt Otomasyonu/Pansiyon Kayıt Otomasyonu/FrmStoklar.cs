    ...
    public partial class FrmStoklar : Form
    {
        ...
        private void veriler()
        {
            ...
            while(oku.Read())
            {
                ...
                ekle.SubItems.Add(oku["TemizlikUrunleri"].ToString());
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Stoklar(Gida,İcecek,TemizlikUrunleri) values ('" + TxtGidalar.Text + "','" + Txtİcecekler.Text + "','" + TxtTemizlik.Text + "')", baglanti);
