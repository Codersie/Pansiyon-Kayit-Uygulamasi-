...
namespace Pansiyon_Kayıt_Otomasyonu
{
    public partial class FrmGelirGider : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=MONSTER\\SQLEXPRESS;Initial Catalog=OrkidePansiyon;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int sonuç;
            sonuç = Convert.ToInt32(LblKasaToplam.Text) - (Convert.ToInt32(LblPersonelMaas.Text) + Convert.ToInt32(LblAlinanUrunler1.Text) + Convert.ToInt32(LblAlinanUrunler2.Text) + Convert.ToInt32(LblAlinanUrunler3.Text) + Convert.ToInt32(LblFaturalar1.Text) + Convert.ToInt32(LblFaturalar2.Text) + Convert.ToInt32(LblFaturalar3.Text));
        ...
        private void FrmGelirGider_Load(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut4 = new SqlCommand("Select sum(TemizlikUrunleri) as toplam3 from Stoklar", baglanti);
